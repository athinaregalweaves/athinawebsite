...
const LinenSection = ({ caption, title, subtitle, description, image, imagePosition, imageZoom = 100, redirect, buttonText }: LinenSectionProps) => (
